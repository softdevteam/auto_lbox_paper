...
For example, in a composition of Java and SQL, where SQL statements are allowed
...
In this paper we present the \emph{automatic language boxes} algorithm, which can
...
possible outcomes from inserting text in an inner language. We have

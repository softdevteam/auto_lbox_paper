...
non-whitespace tokens forward from the \laurie{point of the syntax error?}: if
one or more candidates is successful up to that point it outranks all
...
around part of the fragment, but some was left in the outer language, cause a
...
language even though it caused a syntax errors later in the program
...
to do with lua's syntactic structure?} The stack candidates heuristic, however,

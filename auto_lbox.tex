...
\laurie{i think we need to talk a bit about recognisers here. for example, when
we find a place we'd like to think about inserting language boxes, do we try
all possible languages in the composition? just the ones valid at that point?
how far forward do we search?}
...
point in parsing stack at the point of an error as a proxy for sensible

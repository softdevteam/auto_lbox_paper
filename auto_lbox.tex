...
\begin{table*}[tb]
    ...
    \vspace{7pt}
    \caption{\laurie{can we use `error' or `errors' in the table? at the moment we have `partial insertion (errors)' and `no insertion (error)'. i mildly prefer `errors' but don't feel strongly.}The total percentage of outcomes by category. See

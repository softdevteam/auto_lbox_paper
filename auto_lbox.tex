...
ambiguities (since traditional lexers implicitly resolve many ambiguities before parsing, such
as between identifiers and keywords).
...
the automatic language boxes algorithm.

...
Tokens have a mutable type \laurie{is it true that nonterminals have an immutable type but terminals have a mutable type?} (e.g.~`int')
and a mutable value (e.g.~`3') and are mutable. Figure \ref{fig_example_parsetree}

...
has no concept of function definitions, compositions with SQL as the
outer language \laurie{lukas you wrote: ``Note that, since the concept
of function definitions doesn't exist in SQL, any composition
with SQL as the inner language only allows statements to be embedded.'' but

...
essence, we present a heuristic which can insert, remove, and update\lukas{the only update mechanism is expanding or shrinkig, so we may just say resize here instead} language
...
the notion of ``I'm still typing here'', where automatically inserted language boxes
start as \emph{uncommitted} (meaning they can still be updated or removed) and

...
associated with automatic language boxes) was 0.004s. \laurie{i would prefer to say ``X out of Y'' rather than ``less than 1\%''} Less than 1\% had a per-keypress wall-clock time above 0.1s (often

...
associated with automatic language boxes) was 0.004s. Less than 1\% had a per-keypress wall-clock time above 0.1s (often
considered the threshold at which humans start to perceive some lag from
typing), with a worst case of 0.30s. These times are good on their own, but we

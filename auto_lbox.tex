...
everything associated with automatic language boxes) was approximately 0.006s,
with only 2 tests experiencing an average per-keypress wall-clock time above 0.1s
and a worst case of 0.17s.

...
the candidates from the individual heuristics, filters out any candidates which
consist solely of a single whitespace token (since nearly all languages allow
whitespace tokens, such candidates are valid, but not useful), ranks the
remainder, and removes all of the non-best candidates.

...
\caption{A generic candidates recogniser which produces the ending offsets of
  ...
  implicit EOS (End Of String) token, we assume that further input cannot fix the parse
...
is the beginning of the subtree)}\laurie{ok, you need to expand this, particulary the "technically" point, as i think this is probably interesting stuff that the reader needs to know about!}. This approach

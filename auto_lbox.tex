...
In this section, we present a novel solution to this problem which shows that
it is possible, in many cases, to automatically insert, remove, and resize
language boxes --- automatic language boxes. We start by
...
change. On top of this, we also assert that a realistic solution to the overall
problem should satisfy several softer considerations.

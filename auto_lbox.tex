...
which can also be shifted after the language box, confirming it.}\laurie{ok, this example is going to confuse readers because the pasting thing feels weird. can we find a simpler example that triggers just with normal typing?}The

...
inserted, a Java/PHP syntax error is detected, and the parse tree rewritten,
generally in such a way that the `\texttt{\{}' character is placed after
a terminal in an existing nonterminal -- at which point the parse tree

...
inserted terminals to be detached from the tree~\cite[p.~60]{wagner98practicalalgorithms}\lukas{It's not directly spelled out here but ``the input is a mixture of old subtrees from the previous version of the tree'' somewhat implies it}. Fortunately, we can solve this

...
\begin{figure}
    ...
    \caption{Example showing automatic language boxes in action. Here the user
    is editing a program using a composition of SQLite and Java. \textbf{a)}
...
where one language ends and another beings. However, since languages may share
a similar syntax this is even for an experienced programmar sometimes an
...
stack) to help help us decide whether the insertion of a box is a valid choice.
The basic idea is that analyse the area surrounding the error to find language

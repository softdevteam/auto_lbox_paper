...
\begin{table*}[tb]
    ...
    page~\pageref{detailed categories}\lukas{the page number is missing, possible because we removed page numbers as per requirement} for a detailed description of each category.

...
mechanism atop incremental parsing -- can be extended to explore the grey
...
inserting and updating delimiters, and making use of the user's editing history.
By definition this cannot always achieve a

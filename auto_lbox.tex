...
mechanism atop incremental parsing -- can be extended to in way that fits
...
input, taking into account the user's editor history, and inserting, removing,
or moving delimiters -- leading to what we call \emph{automatic language

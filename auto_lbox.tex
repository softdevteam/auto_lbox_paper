...
expression contained several subexpressions. Overall, we identified 2,474 \laurie{this is a really low total: less than 10 expressions per PHP file?}
...
\laurie{lukas: these tables need a brief intro and explanation}

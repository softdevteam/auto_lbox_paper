...
inner language may only replace expressions with whole SQL statements. The
...
\begin{description*}
  ...
  \item[Invalid insertion] A language box was inserted, but the initial error that triggered the heuristics remained.

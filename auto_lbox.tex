...
generated \laurie{XXX} pairs from our corpus.


\subsection{Results}

We break the results of our experiment down in two ways: by acceptable results
per language composition (Table~\ref{tbl:vald}); and by detailed outcome in the
overall benchmark suite (Table~\ref{tbl:breakdown}).

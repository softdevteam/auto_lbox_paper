...
the notion of ``I'm still typing here'', where automatically language boxes
start as \emph{uncommitted} (when they can still be updated or removed) and
\emph{committed} (when the heuristic takes them as a given). Language boxes
...
cursor); users can manually change a committed box to uncommitted if they later

...
A language box in an uncommitted state is subject to automatic changes. If the
language box or its surrounding area changes, they may automatically removed
or resized by the algorithm.

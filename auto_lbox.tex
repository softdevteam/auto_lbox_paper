...
\begin{table*}[tb]
    ...
    \caption{The total percentage of acceptable outcomes for each benchmark and
      ...
      the outer language; or there multiple candidates were presented to the
...
and PHPLua compositions. Many Lua fragments consists of Lua tables\footnote{Often called associative arrays,
hashmaps, or dictionaries in other languages.}, which have the syntax
`\texttt{\{e1, ..., en\}}'. When typing this fragment, the initial `\texttt{\{}' is
inserted after a terminal in an existing nonterminal, and immediately causes a
Java/PHP syntax error -- at which point the parse tree
heuristic does not consider it as a starting location for a language box.
